...
void MPCSolver::SetTrajectory(CubicTrajectoryGenerator Trajectory[3])
{
    ...
    xd[6] = sharedMemory->baseDesiredEulerVelocity[0];
    xd[7] = sharedMemory->baseDesiredEulerVelocity[1];
    xd[8] = sharedMemory->baseDesiredEulerVelocity[2];
    xd[9] = sharedMemory->baseDesiredVelocity[0];
    xd[10] = sharedMemory->baseDesiredVelocity[1];
    xd[13+6] = sharedMemory->baseDesiredEulerVelocity[0];
    xd[13+7] = sharedMemory->baseDesiredEulerVelocity[1];
    xd[13+8] = sharedMemory->baseDesiredEulerVelocity[2];
    xd[13+9] = sharedMemory->baseDesiredVelocity[0];
    xd[13+10] = sharedMemory->baseDesiredVelocity[1];
